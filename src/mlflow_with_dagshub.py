...
mlflow.set_experiment('Wine-Experiment-2')
with mlflow.start_run():
    ...
    mlflow.sklearn.save_model(rf, "Random Forest Classifier-2") # name should be different each time even if you're in separate experiments
